...
def main(_):
    ...
    with tf.Graph().as_default(), tf.Session() as session:
        ...
        with tf.variable_scope("Model", initializer=initializer):
            ...
            train_model.update(myCode.dga2_GAN.dga_model.autoencoder_train_graph(train_model.en_decoder_loss,
                                                                   FLAGS.learning_rate,
                                                                   FLAGS.max_grad_norm))
        ...
        if FLAGS.load_model:
            ...
            print('Created and initialized fresh model. Size:', myCode.dga2_GAN.dga_model.model_size())
